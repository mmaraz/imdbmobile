    ...
    public partial class FilmographyControl : ImdbMobile.UI.SlidingList
    {
        ...
        private void SetImdbInformation(ImdbActor actor)
        {
            try
            {
                ...
                foreach (ImdbKnownFor ikf in actor.KnownForFull)
                {
                    ...
                    mpi.YIndex = actor.KnownForFull.IndexOf(ikf);
                    ...
                    this.Invoke(us, new object[] { mpi.YIndex+1, actor.KnownForFull.Count });
                }
