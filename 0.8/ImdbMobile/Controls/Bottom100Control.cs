...
{
    public partial class Bottom100Control : ImdbMobile.UI.SlidingList
    {
        ImageDownloader id = new ImageDownloader();

        private void Update(int Current, int Total)
        {
            ((UI.LoadingButton)this.LoadingList.Items[0]).Text = UI.Translations.GetTranslated("0125") + ".\n(" + Current + " " + UI.Translations.GetTranslated("0050") + " " + Total + ")";
        ...
        public Bottom100Control()
        {
            ...
            UI.KListFunctions.ShowLoading(UI.Translations.GetTranslated("0125") + ".\n" + UI.Translations.GetTranslated("0002") + "...", this.LoadingList);
        ...
        {
            Bottom100Parser t2p = new Bottom100Parser();
        ...
        {
            Bottom100Parser t2p = (Bottom100Parser)sender;
